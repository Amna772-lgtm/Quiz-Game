...
public class ShiftsAdapter extends RecyclerView.Adapter<ShiftsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.shiftNumberTextView.setText("Quiz " + (position + 1));
        ...
        for (int i = 0; i < shift.size(); i++) {
            ...
            if (i == shift.size() - 1) {
                ...
                spannableAnswer.setSpan(new ForegroundColorSpan(Color.DKGRAY), 0, spannableAnswer.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
